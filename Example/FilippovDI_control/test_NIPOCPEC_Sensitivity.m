...
StageCost.tauRef = zeros(2, nStages);
StageCost.xWeight = 2;
StageCost.tauWeight = [0.00001; 0.00001]; 
TerminalCost.xRef = 5/3;
TerminalCost.tauRef = [0; 0];
TerminalCost.xWeight = 2;
TerminalCost.tauWeight = [0.00001; 0.00001];
...
plot(x0, costRecord(1, :), 'k',...
    x0, costRecord(2, :), 'b',...
    x0, costRecord(3, :), 'r', 'LineWidth', 1.2)
legend('1e-1', '1e-2', '1e-3')
xlabel('x0')
ylabel('cost')
